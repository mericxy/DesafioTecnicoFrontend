...
function TemperatureBatteryChartComponent({ data }: Props) {
  ...
  return (
    <div className="rounded-xl shadow-md p-4 bg-white w-full">
      <h2 className="text-lg font-bold mb-2">Temperatura Bateria (°C)</h2>
      <ChartContainer 
        config={chartConfig} 
...
export const TemperatureBatteryChart = memo(TemperatureBatteryChartComponent);